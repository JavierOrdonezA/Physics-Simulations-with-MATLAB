...
[t,x,vx,a1,y,vy,a2,z,vz,a3,E] = Function_verlet(af1,x1,v1,af2,x2,v2,af3,x3,v3,t0,tf,n,Ef);
...
text(0.5, 0.98, 'Mass-spring system in horizontal plane, Verlet', 'HorizontalAlignment', 'center', 'FontSize', 13); 

print -djpeg -r200 Mass_spring_systen_Verlet.jpeg