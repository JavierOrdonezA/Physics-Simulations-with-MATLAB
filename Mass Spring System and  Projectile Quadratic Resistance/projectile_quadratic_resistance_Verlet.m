...
[t,x,vx,a1,y,vy,a2,z,vz,a3,E] = Function_verlet(af1,x1,vx1,af2,y1,vy1,af3,z1,vz1,t0,tf,n,Ef);
...
text(0.5, 0.98, 'Motion of a projectile with quadratic resistance, Verlet', 'HorizontalAlignment', 'center', 'FontSize', 13); 

print -djpeg -r200 MotionProjectileVerlet.jpeg
