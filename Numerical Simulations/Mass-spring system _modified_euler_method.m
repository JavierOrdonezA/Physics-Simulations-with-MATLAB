...
[t,x,vx,a1,y,vy,a2,z,vz,a3,E] = Function_Modified_Euler_Method(af1,x1,v1,af2,x2,v2,af3,x3,v3,t0,tf,n,Ef);

figure(1);clf; 
subplot(2,2,1); plot(t,x,t,y,t,z); grid on;
xlabel('Time t'); ylabel('Posicion x_i'); legend('m_1','m_2','m_3');
...
text(0.5, 0.98, 'Mass-spring system in horizontal plane, Modified Euler', 'HorizontalAlignment', 'center', 'FontSize', 13); 

print -djpeg -r200 Mass_spring_systen_EulerM.jpeg